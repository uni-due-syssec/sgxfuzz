...
class qemu_aux_buffer:
    ...
    def get_crashing_struct_info(self):
        # Expected layout b"0xabababab; 48:0x7f61ef215fd0 2 16 0:0x7f61ef1f4000 0 32 0:0x7f61ef1f2000 0"
        return self.get_misc_buf()
    ...
    def set_timeout(self, timeout):
        ...
        # FIXME: when using seconds, returned runtime_usec has overflows??
        #secs = 0
        #usec = int(1000*(timeout))
        secs = int(timeout)
